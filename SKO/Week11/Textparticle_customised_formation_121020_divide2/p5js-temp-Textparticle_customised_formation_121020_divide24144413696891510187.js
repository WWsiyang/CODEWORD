...
function draw() {
  ...
  textAlign(CENTER,TOP);
   textSize(12);
  text('alphabetic language can be considered a digital structure because it consists of a small symbol set that can be',width/5,height/7,500,300);
  
  textAlign(RIGHT,BOTTOM);
  text('Cayley',width-100,height-100);
 
  textAlign(CENTER,TOP);
   fill(255,0,0,fade);
  textSize(15);
  text('[click to explore]',width/7,height/4,600,300);
